									...
									<div class="form-group">												
										<div class="col-md-12">																									 
											<div class="alert alert-info fade in">  
												...
												<div class="form-group">
													<label for="history_survey" class="col-lg-12 control-label"><strong>HISTORY SURVEY</strong></label>
												</div>

												<?php
												include 'koneksi2.php';

												$sql_survey1 = mysqli_query($conn, "SELECT CID, LUP, DATE_FORMAT(LUP, '%M %Y') as bulan_survey, SURVEY  FROM TRANS 
												WHERE CID = '".$cid."' AND MONTH(LUP) = MONTH(now()) AND YEAR(LUP) = YEAR(now())  AND SURVEY IS NOT NULL ORDER BY LUP DESC LIMIT 1");
												$sql_survey_total1 = mysqli_num_rows($sql_survey1);
												if($sql_survey_total1 > 0) {
													while ($ss1 = mysqli_fetch_row($sql_survey1)) {
												?>

												<div class="form-group">
													<label for="history_surver_month1" class="col-lg-3 control-label"><strong>&ensp;&ensp;- <?=date('F Y')?></strong></label>
													<div class="col-lg-9">
														<input type="text" width="50px" class="form-control"  name="history_surver_month1" placeholder="" value= "<?php echo $ss1[3];?>" readonly>
													</div>
												</div>
												...
												<div class="form-group">
													<label for="history_surver_month1" class="col-lg-3 control-label"><strong>&ensp;&ensp;- <?=date('F Y')?></strong></label>
													<div class="col-lg-9">
														<input type="text" width="50px" class="form-control"  name="history_surver_month1" placeholder="" value= "TIDAK ADA" readonly>
													</div>
												</div>
												<?php
												}
											
												$sql_survey2 = mysqli_query($conn, "SELECT CID, LUP, DATE_FORMAT(LUP, '%M %Y') as bulan_survey, SURVEY  FROM TRANS 
												WHERE CID = '".$cid."' AND MONTH(LUP) = MONTH( DATE_SUB(NOW(), INTERVAL 1 MONTH)) AND YEAR(LUP) = YEAR(DATE_SUB(NOW(), INTERVAL 1 MONTH))  AND SURVEY IS NOT NULL ORDER BY LUP DESC LIMIT 1");
												$sql_survey_total2 = mysqli_num_rows($sql_survey2);
												if($sql_survey_total2 > 0) {
													while ($ss2 = mysqli_fetch_row($sql_survey2)) {
												?>

												<div class="form-group">
													<label for="history_surver_month2" class="col-lg-3 control-label"><strong>&ensp;&ensp;- <?=date('F Y',strtotime('-1 months'))?></strong></label>
													<div class="col-lg-9">
														<input type="text" width="50px" class="form-control"  name="history_surver_month2" placeholder="" value= "<?php echo $ss2[3];?>" readonly>
													</div>
												</div>
												...
												<div class="form-group">
													<label for="history_surver_month2" class="col-lg-3 control-label"><strong>&ensp;&ensp;- <?=date('F Y',strtotime('-1 months'))?></strong></label>
													<div class="col-lg-9">
														<input type="text" width="50px" class="form-control"  name="history_surver_month2" placeholder="" value= "TIDAK ADA" readonly>
													</div>
												</div>
												<?php
												}
											
												$sql_survey3 = mysqli_query($conn, "SELECT CID, LUP, DATE_FORMAT(LUP, '%M %Y') as bulan_survey, SURVEY  FROM TRANS 
												WHERE CID = '".$cid."' AND MONTH(LUP) = MONTH( DATE_SUB(NOW(), INTERVAL 2 MONTH)) AND YEAR(LUP) = YEAR( DATE_SUB(NOW(), INTERVAL 2 MONTH))  AND SURVEY IS NOT NULL ORDER BY LUP DESC LIMIT 1");
												$sql_survey_total3 = mysqli_num_rows($sql_survey3);
												if($sql_survey_total3 > 0) {
													while ($ss3 = mysqli_fetch_row($sql_survey3)) {
												?>

												<div class="form-group">
													<label for="history_surver_month3" class="col-lg-3 control-label"><strong>&ensp;&ensp;- <?=date('F Y',strtotime('-2 months'))?></strong></label>
													<div class="col-lg-9">
														<input type="text" width="50px" class="form-control"  name="history_surver_month3" placeholder="" value= "<?php echo $ss3[3];?>" readonly>
													</div>
												</div>
												...
												<div class="form-group">
													<label for="history_surver_month3" class="col-lg-3 control-label"><strong>&ensp;&ensp;- <?=date('F Y',strtotime('-2 months'))?></strong></label>
													<div class="col-lg-9">
														<input type="text" width="50px" class="form-control"  name="history_surver_month3" placeholder="" value= "TIDAK ADA" readonly>
													</div>
												</div>
												<?php
												}
