 			...
 			<form id="form" name="demoform" method="post" action="form_insert.php">
			  ...
			  // </button></div>");
 				...
 				<?php
							...
							if ($total_nilai != 100) {
								if (($tgl_nilai_text != "") and  ($qqqq2 != "") and ($nilai != "") and ($item != "") and ($tgl_ol_text != "") and ($record_id != "") and ($msisdn != "") and ($rs_monitoring != "") and ($jam != "") and ($param_tapping_proses != "") and ($param_tapping_sikap != "") and ($ofi != "") and ($lup != "") and ($human != "") and ($system_prosedur != "") and ($tools != "") and ($qco != "") and ($area_cbo != "") and ($nilaipl != "") and ($nilaisl != "") and ($periode != "") and ($qqqq != "") and ($nd != "") and ($smile_voice != "")) {


									$sql = "INSERT INTO `app_kinerja_nilai` (`tanggal`,`user_id`,`nilai`,`item`,`tglrecord`,`recordid`,`ani`,`reason_monitoring`,`durasi`,`param_tapping_proses`,`param_tapping_sikap`,`ofi`,`lup`,`status`,`human`,`system_prosedur`,`tools`,`lup_qa`,`area`,`proses_layanan`,`sikap_layanan`,`periode`,`lup_tl_name`,`nd`,`smile_voice`) 
			VALUES ('$tgl_nilai_text','$qqqq2','$nilai','$item','$tgl_ol_text','$record_id','$msisdn','$rs_monitoring','$jam','$param_tapping_proses','$param_tapping_sikap','$ofi','$lup','1','$human','$system_prosedur','$tools','$qco','$area_cbo','$nilaipl','$nilaisl','$periode','$qqqq','$nd','$smile_voice')";
									//echo "$sql";
									...
									$sql1 = "INSERT INTO `app_kinerja_nilai_reject` (`tanggal`,`user_id`,`nilai`,`item`,`tglrecord`,`recordid`,`ani`,`reason_monitoring`,`durasi`,`param_tapping_proses`,`param_tapping_sikap`,`ofi`,`lup`,`status`,`human`,`system_prosedur`,`tools`,`lup_qa`,`area`,`proses_layanan`,`sikap_layanan`,`periode`,`lup_tl_name`,`nd`,`smile_voice`) 
			VALUES ('$tgl_nilai_text','$qqqq2','$nilai','$item','$tgl_ol_text','$record_id','$msisdn','$rs_monitoring','$jam','$param_tapping_proses','$param_tapping_sikap','$ofi','$lup','1','$human','$system_prosedur','$tools','$qco','$area_cbo','$nilaipl','$nilaisl','$periode','$qqqq','$nd','$smile_voice')";
			  ...
			  // </button></div>");
					...
					<span aria-hidden='true'>&times;</span>
								...
								if (($tgl_nilai_text != "") and  ($qqqq2 != "") and ($nilai != "") and ($item != "") and ($tgl_ol_text != "") and ($record_id != "") and ($msisdn != "") and ($rs_monitoring != "") and ($jam != "") and ($param_tapping_proses != "") and ($param_tapping_sikap != "") and ($ofi != "") and ($lup != "") and ($human != "") and ($system_prosedur != "") and ($tools != "") and ($qco != "") and ($area_cbo != "") and ($nilaipl != "") and ($nilaisl != "") and ($periode != "") and ($qqqq != "") and ($nd != "") and ($smile_voice != "")) {
									...
									$sql = "INSERT INTO `app_kinerja_nilai` (`tanggal`,`user_id`,`nilai`,`item`,`tglrecord`,`recordid`,`ani`,`reason_monitoring`,`durasi`,`param_tapping_proses`,`param_tapping_sikap`,`ofi`,`lup`,`status`,`human`,`system_prosedur`,`tools`,`lup_qa`,`area`,`proses_layanan`,`sikap_layanan`,`periode`,`lup_tl_name`,`nd`,`smile_voice`) 
				VALUES ('$tgl_nilai_text','$qqqq2','$nilai','$item','$tgl_ol_text','$record_id','$msisdn','$rs_monitoring','$jam','$param_tapping_proses','$param_tapping_sikap','$ofi','$lup','3','$human','$system_prosedur','$tools','$qco','$area_cbo','$nilaipl','$nilaisl','$periode','$qqqq','$nd','$smile_voice')";
									//echo "$sql";
									//$query=mysqli_query($conn, $sql);
									//Refresh by HTTP META
