...
if ( strlen ($_POST['msg_to']) > 1) {
    ...
    $sql = "SELECT a.username, a.name FROM ".$database_prefix."_users a, ".$database_prefix."_users_extended b WHERE $cari AND a.user_level>0 AND a.username != 'admin' AND b.user13='AKTIF' AND b.user3 like 'Agent%' AND a.user_id=b.user_id";
    $rs  = mysql_query( $sql);
?>
