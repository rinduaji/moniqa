...
[
	...
	["||Agent POTS ","index.php?name=Mon_call&file=list_penilaian&agent=Agent POTS","images/b011.gif","images/b01.gif","penilaian Agent POTS","_parent",],
	["||Agent Flexi ","index.php?name=Mon_call&file=list_penilaian&agent=Agent Flexi","images/b011.gif","images/b01.gif","penilaian Agent Flexi","_parent",],
	["||Agent speedy ","index.php?name=Mon_call&file=list_penilaian&agent=Agent speedy","images/b011.gif","images/b01.gif","penilaian Agent Speedy","_parent",],
	["||Agent Inb Sales ","index.php?name=Mon_call&file=list_penilaian&agent=Agent Inb Sales","images/b011.gif","images/b01.gif","penilaian Agent Inb Sales","_parent",],
	["||Agent Out Sales ","index.php?name=Mon_call&file=list_penilaian&agent=Agent Out Sales","images/b011.gif","images/b01.gif","penilaian Agent Out Sales","_parent",],
	["||Agent Komplain ","index.php?name=Mon_call&file=list_penilaian&agent=Agent Komplain","images/b011.gif","images/b01.gif","penilaian Agent Komplain","_parent",],
	["||Agent Informasi ","index.php?name=Mon_call&file=list_penilaian&agent=Agent Informasi","images/b011.gif","images/b01.gif","penilaian Agent Informasi","_parent",],
	["||Agent Registrasi ","index.php?name=Mon_call&file=list_penilaian&agent=Agent Registrasi","images/b011.gif","images/b01.gif","penilaian Agent Registrasi","_parent",],

	["|Penilaian Susulan","","images/b011.gif","images/b01.gif","penilaian Susulan Agent","_parent",],
	["||Agent POTS ","index.php?name=Mon_call&file=list_susulan&agent=Agent POTS","images/b011.gif","images/b01.gif","penilaian Susulan Agent POTS","_parent",],
	["||Agent Flexi ","index.php?name=Mon_call&file=list_susulan&agent=Agent Flexi","images/b011.gif","images/b01.gif","penilaian Susulan Agent Flexi","_parent",],
	["||Agent speedy ","index.php?name=Mon_call&file=list_susulan&agent=Agent speedy","images/b011.gif","images/b01.gif","penilaian Susulan Agent Speedy","_parent",],
	["||Agent Inb Sales ","index.php?name=Mon_call&file=list_susulan&agent=Agent Inb Sales","images/b011.gif","images/b01.gif","penilaian Susulan Agent Inb Sales","_parent",],
	["||Agent Out Sales ","index.php?name=Mon_call&file=list_susulan&agent=Agent Out Sales","images/b011.gif","images/b01.gif","penilaian Susulan Agent Out Sales","_parent",],
	["||Agent Komplain ","index.php?name=Mon_call&file=list_susulan&agent=Agent Komplain","images/b011.gif","images/b01.gif","penilaian Susulan Agent Komplain","_parent",],
	["||Agent Informasi ","index.php?name=Mon_call&file=list_susulan&agent=Agent Informasi","images/b011.gif","images/b01.gif","penilaian Susulan Agent Informasi","_parent",],
	["||Agent Registrasi ","index.php?name=Mon_call&file=list_susulan&agent=Agent Registrasi","images/b011.gif","images/b01.gif","penilaian Susulan Agent Registrasi","_parent",],
	["-"],
