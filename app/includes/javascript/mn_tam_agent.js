...
[
	...
	["-"],
	["Input","index.php?name=tam_dcs&file=input_tam","images/new1-05.gif","images/new1-05.gif","Input data","_parent",],
	["-"],
	["List Order","","images/new1-05.gif","images/new1-05.gif","List Order","_parent",],
    ["|List Order Transaksional","index.php?name=tam_dcs&file=form_agent","images/b011.gif","images/b01.gif","List Order Transaksional","_parent",],
	["|List Recall","index.php?name=tam_dcs&file=list_recall","images/b011.gif","images/b01.gif","List Recall","_parent",],
	["|List Foolow Up","index.php?name=tam_dcs&file=list_follow","images/b011.gif","images/b01.gif","List Follow","_parent",],
	["-"],
