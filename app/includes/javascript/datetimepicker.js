...
var SundayColor="#ccccc";//Background color of Sunday.
var SaturdayColor="#ccccc";//Background color of Saturday.
var WeekDayColor="#ccccc";//Background color of weekdays.
var FontColor="#FFFFFF";//color of font in Calendar day cell.
var TodayColor="#ddd";//Background color of today.
...
function RenderCal()
{
	...
	if (Cal.Scroller=="DROPDOWN")
	{
		...
		for (i = 1930; i < (dtToday.getFullYear() + 5);i++)
		{
			if (i==Cal.Year)
				SelectStr="Selected";
			else
