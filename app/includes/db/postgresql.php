...
class sql_db extends sql_parent
{
	...
	function error($query_id)
	{
		return array('message' => pg_last_error($this->connect_id), 'code' => -1);
	}
	function escape_string($string) { return pg_escape_string($string); }
	function escape_binary($string) { return pg_escape_bytea($string); }
