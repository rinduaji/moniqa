 	...
 	<section id="main-content">
 		...
 		<section class="wrapper">
 			...
 			<!-- <form name="form1" id="form1" method="post" action="simpan.php" > -->
 				<form id="form" name="demoform" method="post" action="form_ideas_detail.php?agent=<?php echo $agent;?>&telp=<?php echo $telp1;?>">
 					<?php
...
// $item='1;-|1;1|2;-|2;1|2;2|2;3|3;-|3;1|3;2|4;-|4;1|4;2|5;-|5;1|6;-|6;1|7;-|7;1|7;2|7;3|';
	...
	if($total_nilai != 100){
		if(($tgl_nilai_text != "") AND  ($qqqq2 != "") AND ($nilai != "") AND ($item != "") AND ($tgl_ol_text != "") AND ($record_id != "") AND ($msisdn != "") AND ($rs_monitoring != "") AND ($jam != "") AND ($param_tapping_proses != "") AND ($param_tapping_sikap != "") AND ($ofi != "") AND ($lup != "") AND ($human != "") AND ($system_prosedur != "") AND ($tools != "") AND ($qco != "") AND ($area_cbo != "") AND ($nilaipl != "") AND ($nilaisl != "") AND ($periode != "") AND ($qqqq != "") AND ($nd != "")){

			$sql="INSERT INTO `app_kinerja_nilai` (`tanggal`,`user_id`,`nilai`,`item`,`tglrecord`,`recordid`,`ani`,`reason_monitoring`,`durasi`,`param_tapping_proses`,`param_tapping_sikap`,`ofi`,`lup`,`status`,`human`,`system_prosedur`,`tools`,`lup_qa`,`area`,`proses_layanan`,`sikap_layanan`,`periode`,`lup_tl_name`,`nd`) 
			VALUES ('$tgl_nilai_text','$qqqq2','$nilai','$item','$tgl_ol_text','$record_id','$msisdn','$rs_monitoring','$jam','$param_tapping_proses','$param_tapping_sikap','$ofi','$lup','1','$human','$system_prosedur','$tools','$qco','$area_cbo','$nilaipl','$nilaisl','$periode','$qqqq','$nd')";
		//echo "$sql";
	...
	// if ($query=mysqli_query($conn, $sql)) {
			...
			$sql1="INSERT INTO `app_kinerja_nilai_reject` (`tanggal`,`user_id`,`nilai`,`item`,`tglrecord`,`recordid`,`ani`,`reason_monitoring`,`durasi`,`param_tapping_proses`,`param_tapping_sikap`,`ofi`,`lup`,`status`,`human`,`system_prosedur`,`tools`,`lup_qa`,`area`,`proses_layanan`,`sikap_layanan`,`periode`,`lup_tl_name`,`nd`) 
			VALUES ('$tgl_nilai_text','$qqqq2','$nilai','$item','$tgl_ol_text','$record_id','$msisdn','$rs_monitoring','$jam','$param_tapping_proses','$param_tapping_sikap','$ofi','$lup','1','$human','$system_prosedur','$tools','$qco','$area_cbo','$nilaipl','$nilaisl','$periode','$qqqq','$nd')";
		...
		if(($tgl_nilai_text != "") AND  ($qqqq2 != "") AND ($nilai != "") AND ($item != "") AND ($tgl_ol_text != "") AND ($record_id != "") AND ($msisdn != "") AND ($rs_monitoring != "") AND ($jam != "") AND ($param_tapping_proses != "") AND ($param_tapping_sikap != "") AND ($ofi != "") AND ($lup != "") AND ($human != "") AND ($system_prosedur != "") AND ($tools != "") AND ($qco != "") AND ($area_cbo != "") AND ($nilaipl != "") AND ($nilaisl != "") AND ($periode != "") AND ($qqqq != "") AND ($nd != "")){
			...
			$sql="INSERT INTO `app_kinerja_nilai` (`tanggal`,`user_id`,`nilai`,`item`,`tglrecord`,`recordid`,`ani`,`reason_monitoring`,`durasi`,`param_tapping_proses`,`param_tapping_sikap`,`ofi`,`lup`,`status`,`human`,`system_prosedur`,`tools`,`lup_qa`,`area`,`proses_layanan`,`sikap_layanan`,`periode`,`lup_tl_name`,`nd`) 
			VALUES ('$tgl_nilai_text','$qqqq2','$nilai','$item','$tgl_ol_text','$record_id','$msisdn','$rs_monitoring','$jam','$param_tapping_proses','$param_tapping_sikap','$ofi','$lup','3','$human','$system_prosedur','$tools','$qco','$area_cbo','$nilaipl','$nilaisl','$periode','$qqqq','$nd')";
		//echo "$sql";
			$query=mysqli_query($conn, $sql);
	 //Refresh by HTTP META
					...
					<div class="col-lg-12">							
						<section class="panel">
							...
							<div class="panel-body">
								...
								<div align="right">
									<a href="form_ideas_wo.php" class="btn btn-warning">Kembali</a>	
								</div>							
									...
									<div class="form-group">												
										<div class="col-md-12">																									 
											<div class="alert alert-info fade in">  
												...
												$trans_id = $_GET['id'];
												$pkatt = mysqli_query($conn, "SELECT ND
													FROM TRANS_DETAIL
												...
												while ($ckatt = mysqli_fetch_row($pkatt)) {
													...
													<div class="form-group">
														...
														<div class="col-lg-9">
															<input type="text" width="50px" class="form-control"  name="nd" placeholder="" value="<?php echo $ckatt[0];?>" readonly>
														</div>
													</div>
													<?php
												}
