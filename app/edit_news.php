<!DOCTYPE html>
 ...
 <section id="main-content">
 	...
 	<section class="wrapper">
 		...
 		<form id='input' name="demo" action='edit_news.php' method='post' accept-charset='UTF-8' style="overflow-y:auto;" enctype="multipart/form-data">
				...
				if (isset($_POST['Save'])) {
					...
					// if everything is ok, try to upload file
						...
						move_uploaded_file($_FILES["nama_file"]["tmp_name"], $target_file);
							...
							$sql3="UPDATE news SET username_input='$username', nama_input = '$name', tgl_input = '$tanggal', judul = '$judul' ,ket = '$keterangan', nama_file='$nama_file_upload' WHERE id=$id";
							// echo $sql3;
							if (!mysqli_query($conn, $sql3)) {
								echo "<div id='sas' class='alert alert-danger' role='alert'><span class='glyphicon glyphicon-warning-sign'></span> Data News gagal ditambahkan!!</div>";
							} else {
 										...
 										<div class="col-md-12">
                                            <input type="hidden" name="id" value="<?=$_GET['id']?>">
 											<div class="form-group">
 												...
 												<div class="col-lg-8">
 													<input type="text" width="50px" class="form-control" name="judul" placeholder="" value="<?=$_GET['judul']?>">
 												</div>
 											</div>
 											<div class="form-group">
 												<label for="ket" class="col-lg-4 control-label"><strong>Keterangan</strong></label>
 												<div class="col-lg-8"> <textarea name="ket" id="ket" placeholder="" style="width:100%;" rows="8"><?=$_GET['ket']?></textarea>
 												</div>
 											</div>
