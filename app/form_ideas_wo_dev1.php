 													...
 													<table data-toggle="table" class="table table-striped table-bordered table-hover header-fixed" id="sample_xx">
 														...
 														<thead>
 															<tr>
																...
																<th style="padding-top: 3px; padding-bottom: 3px; background-color: #EAEAEA !important">
																	<font face="Verdana" style="font-size: 9pt">CARING
																	</font>
																</th>
																<th style="padding-top: 3px; padding-bottom: 3px; background-color: #EAEAEA !important">
																...
																<th style="padding-top: 3px; padding-bottom: 3px; background-color: #EAEAEA !important">
																	<font face="Verdana" style="font-size: 9pt">CID
																	</font>
																</th>
 																<th style="padding-top: 3px; padding-bottom: 3px; background-color: #EAEAEA !important">
 														...
 														<tbody>
 															<?php
																...
																// while ($qq <= date('m')) {
																	...
																	(SELECT f.UPD_AGENT,f.NAMA_MASTER,f.ALAMAT_MASTER,f.NO_KONTAK,f.TGL_CALL,f.HUB_PENERIMA,f.PENERIMA,f.TRANS_ID,ttd.KENDALA,f.GIMMICK,tnd.FCR,f.CARING,f.KETERANGAN,ttd.ND,ttd.TGL_JANJI_BAYAR,f.CID
																	FROM 
																	(SELECT d.UPD_AGENT,d.NAMA_MASTER,d.ALAMAT_MASTER,d.NO_KONTAK,d.TGL_CALL,d.HUB_PENERIMA,d.PENERIMA,d.TRANS_ID,d.GIMMICK,d.KETERANGAN,d.CID, d.CARING
																	FROM TRANS AS d  
																	JOIN (
																	SELECT max(d.NO_KONTAK) AS m, d.UPD_AGENT,d.CID, d.CARING
																	FROM TRANS as d
																	JOIN (
																	SELECT max(NO_KONTAK) AS m, UPD_AGENT, CID, CARING
																	...
																	while ($row = mysqli_fetch_row($sql)) {
																		# code...																	
																		$data[$i] = array($row[0], $row[1], $row[2], $row[3], $row[4], $row[5], $row[6], $row[7], $row[8], $row[9], $row[10], $row[11], $row[12], $row[13], $row[14], $row[15]);
																	...
																	for ($i = 0; $i < $no; $i++) {
																		for ($j = 0; $j < $total_agent; $j++) {
																			...
																			if ($data_jadi[$j][1] == trim($data[$i][0]) and $_SESSION['name'] == $data_jadi[$j][0]) {
																				...
																				$data_fix[$i] = array(trim($data[$i][0]), $data[$i][1], $data[$i][2], $data[$i][3], $data[$i][4], $data[$i][5], $data[$i][6], $data[$i][7], $data[$i][8], $data[$i][9], $data[$i][10], $data[$i][11], $data[$i][12], $data[$i][13], $data[$i][14], $data[$i][15]);
																...
																?>
 																	<tr class="odd gradeX">
																		...
																		<td style="padding-top: 2px; padding-bottom: 2px">
																		 ...
																		 <td style="padding-top: 2px; padding-bottom: 2px">
 																			<font face="Tahoma" style="font-size: 9pt"><?php echo $data_fix[$i][15]; ?>
 																			</font>
 																		</td>
 																		<td style="padding-top: 2px; padding-bottom: 2px">
 																			<a href="form_ideas_detail_dev1.php?agent=<?php echo $data_fix[$i][0]; ?>&telp=<?php echo $data_fix[$i][3]; ?>&gimmick=<?php echo $data_fix[$i][9]; ?>&fcr=<?php echo $data_fix[$i][10]; ?>&nd=<?php echo $data_fix[$i][13]?>&cid=<?php echo $data_fix[$i][15]?>" class="btn btn-primary btn-sm">Detail</a>
 																		</td>
 																...
 																<?php
																	...
																	?>
																		...
																		<td style="padding-top: 2px; padding-bottom: 2px">
 																			...
 																			<td style="padding-top: 2px; padding-bottom: 2px">
 																				<a href="form_ideas_detail_dev1.php?agent=<?php echo $data_fix[$i][0]; ?>&telp=<?php echo $data_fix[$i][3]; ?>&id=<?php echo $data_fix[$i][7]; ?>&gimmick=<?php echo $data_fix[$i][9]; ?>&fcr=<?php echo $data_fix[$i][10]; ?>&nd=<?php echo $data_fix[$i][13]; ?>&cid=<?php echo $data_fix[$i][15]; ?>" class="btn btn-primary btn-sm">Detail</a>
 																			</td>
