		...
		<section id="main-content" >
			<section class="wrapper" id="section_utama" >
				...
				<form id="form" name="demoform" method="post" action="app_bina_agent_approve_edit.php">
					...
					<input type="hidden" name="nd1" id="nd" value="<?php echo $nd1 ?>">
						...
						<div class="col-lg-12">							
							<section class="panel">
								<div class="revenue-head" style="background: #695a70;-webkit-border-radius: 4px 4px 0px 0px;border-radius: 4px 4px 0px 0px;  color: #fff;line-height: 50px;">		<?php		
															$qsk=mysqli_query($conn, "SELECT a.reason_monitoring,a.tanggal,a.tglrecord,a.user_id,b.name,b.nama_tl,a.lup_qa,a.status,a.recordid,a.ani,a.param_tapping_proses,a.param_tapping_sikap,a.ofi,a.rekomendasi_tl,a.komitmen_agent FROM app_kinerja_nilai AS a INNER JOIN cc147_main_users AS b ON a.user_id = b.username WHERE a.user_id = '$ids' AND a.ani = '$ani'");
															//echo "$qsk";
															$k=1;
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<p class="alert alert-info fade in" style='margin-bottom:15px;position: relative;min-height: 1px;padding-right: 15px;padding-left: 15px;color:purple;'>
														...
														>>  <span style="color:green">Jabatan Penilai</span>   : Tabber Fbcc<span style="color:red"></span>
													</p>													
													<p class="alert alert-warning fade in" style='margin-bottom:15px;position: relative;min-height: 1px;padding-right: 15px;padding-left: 15px;color:purple;'>
													...
													<p class="alert alert-info fade in" style='margin-bottom:15px;position: relative;min-height: 1px;padding-right: 15px;padding-left: 15px;color:purple;'>
														>>  <span style="color:red">Need approve Agent</span>
													</p>
													...
													<p class="alert alert-info fade in" style='margin-bottom:15px;position: relative;min-height: 1px;padding-right: 15px;padding-left: 15px;color:purple;'>
														>><?php echo $rsk[13];?>  <span style="color:red"></span>
													</p>
													<p class="alert alert-warning fade in" style='margin-bottom:15px;position: relative;min-height: 1px;padding-right: 15px;padding-left: 15px;color:purple;'>
													...
													<p class="alert alert-info fade in" style='margin-bottom:15px;position: relative;min-height: 1px;padding-right: 15px;padding-left: 15px;color:purple;'>
														...
														>> <span style="color:green">Tanggal Approve TL</span> : <?php echo "string"; ?><span style="color:red"></span> <br/>
														>> <span style="color:green">Tanggal Approve Tabber</span> : <?php echo "string";?><span style="color:red"></span> <br/>
														>> <span style="color:green">Tanggal Reject TL</span> : <?php echo "string"; ?><span style="color:red"></span> <br/>
								...
								<div class="col-md-4">
										<div role="form">
											...
											<div class="form-group">
												<label class="control-label col-md-12"><strong>Komitmen Agent</strong></label>
												<div class="col-md-12">
...
//echo $nilai;
		...
		$ani = $_POST['ani'];
		$nd1 = $_POST['nd1'];
		$sql="UPDATE `app_kinerja_nilai` SET `komitmen_agent`='$x_rek_tl',`status`=2,`lup_agent`='$lup' WHERE (`tanggal`='$tanggal') AND (`user_id`='$id_bina') AND (`ani` = '$ani') AND (`nd` = '$nd1')";
		echo "$sql";
	
	   	mysqli_query($conn, $sql);
	   	$sql1="UPDATE `app_kinerja_nilai_reject` SET `komitmen_agent`='$x_rek_tl',`status`=2,`lup_agent`='$lup' WHERE (`tanggal`='$tanggal') AND (`user_id`='$id_bina') AND (`ani` = '$ani') AND (`nd` = '$nd1')";
		echo "$sql1";
