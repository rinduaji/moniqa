   ...
   ?> 
		...
		<section id="main-content" >
			<section class="wrapper" id="section_utama" >
				...
				<form id="form" name="demoform" method="post" action="app_bina_qco_rejected_edit.php">
						...
						<div class="col-lg-12">							
							<section class="panel">
								<div class="revenue-head" style="background: #695a70;-webkit-border-radius: 4px 4px 0px 0px;border-radius: 4px 4px 0px 0px;  color: #fff;line-height: 50px;">		<?php		
															$qsk=mysqli_query($conn, "SELECT a.reason_monitoring,a.tanggal,a.tglrecord,a.user_id,b.name,b.nama_tl,a.lup_qa,a.status,a.recordid,a.ani,a.param_tapping_proses,a.param_tapping_sikap,a.ofi,a.rekomendasi_tl,a.komitmen_agent FROM app_kinerja_nilai AS a INNER JOIN cc147_main_users AS b ON a.user_id = b.username WHERE a.user_id = '$ids'");
															//echo "$qsk";
															$k=1;
											...
											<div class="form-group">													
												...
												<div class="form-group">
													...
													<select class="chosen-select" name="x_id_kat_approve">
														<option value="-1">Approve To TL</option>
...
//echo $nilai;
		...
		$sql="UPDATE `app_kinerja_nilai` SET `rekomendasi_qco`='$x_rek_tl',`status`='$x_id_kat_approve',`lup_qc_rejected`='$lup' WHERE (`tanggal`='$tanggal') AND (`user_id`='$id_bina') ";
