...
//echo $nilai;
$nilaipl=$lc_syst1+$lc_syst2+$lc_syst3+$lc_syst4+$lc_syst5+$lc_syst6+$lc_syst7+$lc_syst8+$lc_syst9+$lc_syst10;
$nilaisl=$lc_syst11+$lc_syst12+$lc_syst13;
															...
															<div class="alert alert-info fade in">
																...
																<div class="form-group">
																	...
																	<div class="col-lg-8">
																		...
																		<select  class="chosen-select" name="area_cbo" class="form-control" onChange="document.demoform.submit()">
													...
													<h5 class="alert alert-danger" align="center"><strong>PROSES LAYANAN</strong></h5>
													 <div class="alert alert-success" role="alert" style="margin-bottom: 0px;">
													   ...
													   <div class="form-group" id="div_lc_cust">
														  ...
														  <div class="col-xs-1" style="left: 80px;">											
