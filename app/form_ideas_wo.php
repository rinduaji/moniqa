 					...
 					<section class="panel">
 						...
 						<div class="panel-body">
                            ...
                            -->
            					...
            					ORDER BY UPD_AGENT,NO_KONTAK ASC) AS f JOIN TRANS_DETAIL AS ttd ON f.TRANS_ID= ttd.TRANS_ID AND ttd.PRODUCT_STATUS = 'JANJI MAU BAYAR' GROUP BY f.TRANS_ID ORDER BY f.UPD_AGENT ASC)");
																	...
																	for ($i = 0; $i < $no; $i++) {
																		for ($j = 0; $j < $total_agent; $j++) {
																			...
																			if ($data_jadi[$j][1] == trim($data[$i][0]) and $_SESSION['name'] == $data_jadi[$j][0]) {
																				...
																				$data_fix[$i] = array(trim($data[$i][0]), $data[$i][1], $data[$i][2], $data[$i][3], $data[$i][4], $data[$i][5], $data[$i][6], $data[$i][7], $data[$i][8], $data[$i][9]);
            					...
            					ORDER BY UPD_AGENT,NO_KONTAK ASC) AS f JOIN TRANS_DETAIL AS ttd ON f.TRANS_ID= ttd.TRANS_ID AND td.PRODUCT_STATUS = 'JANJI MAU BAYAR' GROUP BY f.TRANS_ID ORDER BY f.UPD_AGENT ASC)");
