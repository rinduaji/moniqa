...
//require_once('koneksi.php');
   ...
   <SCRIPT language=Javascript>
      ...
      <form id='input' name="demo" action='update_cuti.php' method='post' accept-charset='UTF-8'>
  ...
  //die();
   ...
   //                VALUES ('$username', '$email', '$password','$user_tl','$mktime' , 'gallery/blank.gif', '$user', '0', '0')";
                 ...
                 $sql3="UPDATE app_kinerja_cuti SET username='$username', nama = '$name', tanggal = '$tanggal', keterangan = '$keterangan' WHERE id=$id";
  ...
  echo "<div id='sas' class='alert alert-danger' role='alert'><span class='glyphicon glyphicon-warning-sign'></span>  data $username gagal update di database!!</div>";
				...
				<div class="col-md-12" >
																...
																<div class="form-group">
																	...
																	<div class="col-lg-8">																
								                                     ...
								                                     <select class="chosen-select" name="nama_tabber" id="nama_tabber" class="form-control" onChange="document.demo.submit()">
								                                        ...
								                                        if ($_GET['username']==$ckat[1]){$sel="selected";} else {$sel="";}
																   ...
																   <div class="form-group">
																	...
																	<div class="col-lg-8">																
																		<input type="date" width="50px" class="form-control"  name="tanggal" id="tanggal" placeholder="" value="<?php echo $_GET['tanggal'];?>">	
																	</div>
																  </div>	
																  <div class="form-group">
																	<label for="keterangan" class="col-lg-4 control-label"><strong>Keterangan</strong></label>
																	<div class="col-lg-8">															<textarea name="keterangan" id="keterangan" placeholder="" style="width:100%;" rows="8"><?php echo $_GET['keterangan'];?></textarea>
																	</div>
																  </div>	
												</div>
                    ...
                    <div>
													   ...
													   <div align="center">
														...
														<button  width = "100" type="button" id="Close" name="Close" onclick="window.location.href = './list_cuti.php';" class="btn   btm-block btn-danger">Close</button>
													   </div>
