...
<section id="main-content">
  ...
  <section class="wrapper">
    ...
    <form name="form1" method="post" action="rep_reject.php" >
            ...
            <div class="revenue-head ">
              <span>
                <i class="icon-ticket"></i>
                 ...
                 <h3>Data Report - Reject Team Leader</h3>  
              </div>
...
// $sql=mysqli_query($conn,"Select area,tanggal, COUNT(*) FROM app_kinerja_nilai  WHERE tanggal LIKE '%$qq%' GROUP BY area");
                                      $sql=mysqli_query($conn,"SELECT a.reason_monitoring,a.tanggal,a.tglrecord,a.user_id,b.nama_tl,a.lup_qa,a.status,a.recordid,a.ani,a.param_tapping_proses,a.param_tapping_sikap,a.ofi,a.rekomendasi_tl,a.komitmen_agent,a.human,a.system_prosedur,a.tools,a.nd FROM app_kinerja_nilai_reject AS a INNER JOIN cc147_main_users AS b ON a.user_id = b.username WHERE MONTH(a.tanggal) = '$qq' and YEAR(a.tanggal) = '$q' AND a.status='0'");
 ...
 //echo "Select  area,tanggal, COUNT(*) FROM app_kinerja_nilai  WHERE tanggal LIKE '%$qq%' GROUP BY area";
  ...
  # code...
                                          ...
                                          <td style="padding-top: 2px; padding-bottom: 2px">
                                          <font face="Tahoma" style="font-size: 9pt"><?php echo $row[17];  ?>
                                        </font>
                                      </td>
                                          <td style="padding-top: 2px; padding-bottom: 2px">
...
// $sql=mysqli_query($conn,"Select area,tanggal, COUNT(*) FROM app_kinerja_nilai  WHERE tanggal LIKE '%$qq%' GROUP BY area");
                              $sql=mysqli_query($conn,"SELECT a.reason_monitoring,a.tanggal,a.tglrecord,a.user_id,b.nama_tl,a.lup_qa,a.status,a.recordid,a.ani,a.param_tapping_proses,a.param_tapping_sikap,a.ofi,a.rekomendasi_tl,a.komitmen_agent,a.human,a.system_prosedur,a.tools FROM app_kinerja_nilai_reject AS a INNER JOIN cc147_main_users AS b ON a.user_id = b.username WHERE MONTH(a.tanggal) = '$month' and YEAR(a.tanggal) = '$year' AND a.status='0'");
 //echo "Select  area,tanggal, COUNT(*) FROM app_kinerja_nilai  WHERE tanggal LIKE '%$qq%' GROUP BY area";
                              while($rsk=mysqli_fetch_row($sql)){
