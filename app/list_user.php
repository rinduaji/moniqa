 								...
 								<div class="tab-content tasi-tab">
 									...
 									<table border="0" width="100%">
 										<tr>
 											...
 											<td width="76%">
 												<input type="text" class="form-control"  id="keyword" name="keyword" placeholder="Type keyword here Agent" value="" size="1">
 											</td>
 											...
 											<td>
														...
														<thead>
															<tr>
																<th style="padding-top: 3px; padding-bottom: 3px; background-color: #EAEAEA !important">
																	...
																	<th style="padding-top: 3px; padding-bottom: 3px; background-color: #EAEAEA !important">
																		<font face="Calibri" size="2">User Level
																		</font>
																	</th>
																	...
																	<th style="padding-top: 3px; padding-bottom: 3px; background-color: #EAEAEA !important">
																		<font face="Calibri" size="2">User TL
																		</font>
																	</th>
															...
															if (isset($_POST['Search'])) {
																$sqlo="SELECT b.user1,b.user2,b.user3,b.user7,a.nama_tl,b.user4 FROM cc147_main_users as a, cc147_main_users_extended as b WHERE a.username=b.user1 and b.user3 LIKE '%Fbcc%' and b.user1='$keyword' ORDER BY b.user3";

															}else{
																$sqlo="SELECT b.user1,b.user2,b.user3,b.user7,a.nama_tl,b.user4 FROM cc147_main_users as a, cc147_main_users_extended as b WHERE a.username=b.user1 and b.user3 LIKE '%Fbcc%' ORDER BY b.user3";
															}
						                        ...
						                        # code...
																...
																<tbody>
																	...
																	<tr class="odd gradeX">
																		...
																		<td style="padding-top: 2px; padding-bottom: 2px">
																			...
																			<td style="padding-top: 2px; padding-bottom: 2px">
																				<font face="Calibri" size="2"><?php echo $sqlop[0];?>
																			</font>
																		</td>
															...
															<td style="padding-top: 2px; padding-bottom: 2px">
																<font face="Calibri" size="2">Active
																</font>
															</td>
															<td style="padding-top: 2px; padding-bottom: 2px">
														...
														<td style="padding-top: 2px; padding-bottom: 2px">
															<div align="center">
																<font face="Verdana" style="font-size: 9pt">
																	...
																	<a href="update_user.php?x_userid=<?php echo $sqlop[0];?>&cbo_areaa=<?php echo $sqlop[3];?>&user=<?php echo $sqlop[1];?>&kategori=<?php echo $sqlop[4];?>&segment_cbo=<?php echo $sqlop[2];?>&gender=<?php echo $sqlop[5];?>">
																	...
																	<a href="../app/users_del.php?userid=<?php echo $sqlop[0];?>" onclick="javascript: return(delete_data(<?php echo $sqlop[0];?>))" title="Delete User">
